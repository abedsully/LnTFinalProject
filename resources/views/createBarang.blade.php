    ...
    <form action="/store" method="POST" enctype="multipart/form-data">
        ...
        <div class="d-flex flex-column align-items-center pt-3 gap-3">
            ...
            <div class="form-group col-4">
                ...
                <input type="text" class="form-control @error('amount') is-invalid @enderror" id="exampleInputPassword1" placeholder="Enter the amount" name="amount" value="{{ old('amount') }}">
                @error('amount')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group col-4">
                ...
                <input type="file" class="form-control @error('amount') is-invalid @enderror" id="exampleInputPassword1" name="image" value="{{ old('amount') }}">
                @error('amount')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
